...
public class Servicio {
     ...
     */
    public Servicio(int fotoId, String titulo, String subtitulo, String distancia, String descripcion, String categoriaId) {
        title = titulo;
        distance = distancia;
        subtitle = subtitulo;
...
//VOLLEY
    ...
    public Servicio(String titulo, String subtitulo, String distancia, String descripcion, String categoriaId) {
        title = titulo;
        distance = distancia;
        subtitle = subtitulo;
        description = descripcion;
